...
export const GameInstructionsOverlay = ({ isOpen, onDismiss }: DialogCommonProps) => (
  <Dialog isOpen={isOpen} size="medium" disableEscClose={false} title="Instructions" onDismiss={onDismiss}>
    <Dialog.Body>
      ...
      <p>
        All connceted controllers will begin to vibrate morse code to represent the word or sentence entered by the game
        master.
      </p>
